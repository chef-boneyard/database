...
- MySQL: leverages the `mysql2` gem which is installed as part of the `database::mysql` recipe. You must declare `include_recipe "database::mysql"` to include this in your recipe.
